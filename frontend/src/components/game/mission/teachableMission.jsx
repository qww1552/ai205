...
import { Button, Progress, Card, Carousel, Row, Col } from "antd";
        ...
        if (props.id === "5" || props.id === "10" || props.id === "11") {
          ...
          if (!secondPoseToggle) {
            if (props.subType1 !== currentPose) {
              currentPoseTimer = 0;
              setTeachableProgress(
                props.motion1 + " 동작이 감지되지 않았어요..."
              );
              ...
              setTeachableProgress(
                "좋아요! 다음은 " + props.motion2 + " 동작을 취해주세요!"
              );
